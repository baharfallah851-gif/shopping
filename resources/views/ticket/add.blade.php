...
@section('content')
    <form method="post" action="{{route('ticket.save')}}">
        ...
        <div class="col-md-4 col-sm-12 col-xs-12 form-group">
            ...
            <div id="priority" class="btn-group" data-toggle="buttons" style="margin: 20px">
                <label class="btn btn-default" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                    <input type="radio" name="priority" value="1">up
                </label>
                <label class="btn btn-default" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                    <input type="radio" name="priority" value="2">middle
                </label>
                <label class="btn btn-default" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                    <input type="radio" name="priority" value="3">down
                </label>
            </div>
        </div>
        ...
        <div class="col-md-4 col-sm-1 col-xs-12 form-group">
            <label style="margin: 20px">Would you like to receive an SMS when the support team responds to your ticket?<input type="checkbox" name="send_message" class="form-check-input" value="1" style="margin-inline: 20px"></label>
        </div>
