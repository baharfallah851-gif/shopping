...
<form method="post" action="{{Route('customer.save')}}" class="was-validated">
    ...
    <div class="form-row">
        ...
        <div>
            ...
            <div class="center">
                <button  class="btn btn-success" style="margin-top: 55px" onclick="addAddress();return false">+</button>
            </div>
        </div>
        ...
        <div class="hidden full-address address-tmp">
            ...
            <div class="center">
                <button  class="btn btn-success" style="margin-top: 30px" onclick="addAddress();return false">+</button>
                <button class="btn btn-danger" style="margin-top:30px" onclick="removeAddress(this);return false">_</button>
